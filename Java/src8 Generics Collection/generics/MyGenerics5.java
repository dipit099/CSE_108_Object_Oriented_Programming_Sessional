...
class MyStack  <   T   > implements iStack<T> // T dui jaegae likhte hbe !! Interface tao generic jehetu
...
public class MyGenerics5 {
    public static void main(String args[]) {
        ...
        MyStack<Integer> msi = new MyStack<>(integers);
        msi.push(50);
        msi.push(40);
        msi.push(30);
        msi.push(20);
