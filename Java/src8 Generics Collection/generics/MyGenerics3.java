...
public class MyGenerics3  <T extends X & Y & Z>  
 // bound korar jnne we use this...'X' class ke extend kore je(eg MyY) sudhu taakei use korte parbe ei jaegae
 // and Y, Z interface keo implement kore emon
 // jodi class thake ekhane then seta ke age rakhbei so here X is a class we know that
{
    private T a;
